...
class HoaDonDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'hoadon.action')
            ->setRowId('id');
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('trangthaithanhtoan'),
            Column::make('phuongthucthanhtoan'),
            Column::make('masothue'),
            Column::make('tendonvi'),
            Column::make('diachidonvi'),
