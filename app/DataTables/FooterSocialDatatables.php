...
use App\Models\FooterSocialDatatable;
...
class FooterSocialDatatables extends DataTable
{
    /**
    ...
    {
        return $this->builder()
            ->setTableId('footersocialdatatables-table')
    ...
    {
        return 'FooterSocialDatatables_' . date('YmdHis');
    }
}
